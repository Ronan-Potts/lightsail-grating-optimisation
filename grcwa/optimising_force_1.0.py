'''
This file optimises for transverse force by adjusting the width of each grating element.
'''
import core
...
min_objective = lambda vars: core.grcwa_transverse_force(nG, core.linear_permittivity_geometry(Nx,d,x1,x2,w1,w2,vars[0],vars[1]), Nx, d, theta, freq, beta)
...
while optimising:
    ...
    ## Perform Optimisation
        ...
        while core.valid(vars) == False:
            vars, w1, w2 = core.valid_eps(vars, d, Nx, x1, x2, w1, w2)
