...
'''
MEEP uses FDTD (finite-difference-time-domain) to numerically evaluate Maxwell's equations. This file uses MEEP to evaluate
Maxwell's equations for a diffraction grating which extends infinitely.
'''
...
They also assume an incident plane wave beam of wavelength 1.5 microns. Note that natural units
